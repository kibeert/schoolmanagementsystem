...
with open("student_management_app\conties.json") as file:
    counties_data = json.load(file)

# Convert JSON data to tuple choices
KENYAN_COUNTIES = [(county["name"], county["name"]) for county in counties_data]
